...
public class MarkingTransaction implements PromiseGenerator, HttpHandler {
    ...
    public Promise generate() {
        return servicePromise.get(index, 1_200_000L)
                ...
                .thenWithResource("tppCancel", JdbcResource.class, "default", (_, _, promise, jdbcResource)
                ...
                .thenWithResource("tppAccepted", JdbcResource.class, "default", (_, _, promise, jdbcResource)
                ...
                .thenWithResource("tppNotOrange", JdbcResource.class, "default", (_, _, promise, jdbcResource)
                        -> jdbcResource.execute(new JdbcRequest(TPP.NOT_ORANGE)
                        .addArg(promise.getRepositoryMapClass(ServletHandler.class).getRequestReader().getMap())
                ))
                .thenWithResource("tppFnFuture", JdbcResource.class, "default", (_, _, promise, jdbcResource)
                        -> jdbcResource.execute(new JdbcRequest(TPP.FN_FUTURE)
                        .addArg(promise.getRepositoryMapClass(ServletHandler.class).getRequestReader().getMap())
                ))
                .thenWithResource("tppFillContinue", JdbcResource.class, "default", (_, _, promise, jdbcResource)
                        -> jdbcResource.execute(new JdbcRequest(TPP.FILL_CONTINUE)
                        .addArg(promise.getRepositoryMapClass(ServletHandler.class).getRequestReader().getMap())
                ))
                .thenWithResource("orangeNotTpp", JdbcResource.class, "default", (_, _, promise, jdbcResource)
                        -> jdbcResource.execute(new JdbcRequest(Orange.NOT_TPP)
                        .addArg(promise.getRepositoryMapClass(ServletHandler.class).getRequestReader().getMap())
                ))
                .thenWithResource("orangeFillContinue", JdbcResource.class, "default", (_, _, promise, jdbcResource)
