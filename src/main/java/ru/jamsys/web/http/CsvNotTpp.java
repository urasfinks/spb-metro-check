...
@Component
@RequestMapping
public class CsvNotTpp implements PromiseGenerator, HttpHandler {
    ...
    public CsvNotTpp(ServicePromise servicePromise) {
    ...
    public Promise generate() {
        ...
        return servicePromise.get(index, 60_000L)
                ...
                .then("generateCsv", (_, promise) -> {
                    ...
                    servletHandler.setResponseHeader("Content-Disposition", "attachment;filename=" + getUniqueFileName("orange_not_tpp"));
